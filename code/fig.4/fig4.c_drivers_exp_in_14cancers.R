...
# "1--drivers in tumor vs. non-drivers in tumor"
# "2--drivers in normal vs. non-drivers in normal"
# "3--drivers in tumor vs. drivers in normal"
# "4--non-drivers in tumor vs. non-drivers in normal"
pattern <- 1
